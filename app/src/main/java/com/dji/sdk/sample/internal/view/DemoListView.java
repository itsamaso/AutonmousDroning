...
import com.dji.sdk.sample.demo.lookat.BaseCameraViewMavicMini;
import com.dji.sdk.sample.demo.lookat.LookAtMissionView;
import com.dji.sdk.sample.demo.lookat.MavicMiniWayPoint;
...
public class DemoListView extends FrameLayout {
    ...
    private void initView(Context context) {
        ...
        builder.addGroup(R.string.component_listview_sdk_4_16,
                false,
                new GroupItem(R.string.CameraBaseMavicMini, BaseCameraViewMavicMini.class),
                new GroupItem(R.string.WayPoint, MavicMiniWayPoint.class),
               // new GroupItem(R.string.WayPoint2, WayPoint_2.class),
